...
def main(
    ...
    df['PartOfTheDay'] = pd.cut(df['Hour'], bins=[-1,11,16,20,24], 
    ...
    #dropping unnecessary comments
    cols_to_drop = ["Invoice ID", "gross margin percentage ", "Tax 5%", "cogs", "Date", "Time"]
